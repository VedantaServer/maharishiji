...
class ContentblocksItemWidget extends StatelessWidget {
  ContentblocksItemWidget(this.contentblocksItemModelObj);

  ContentblocksItemModel contentblocksItemModelObj;
