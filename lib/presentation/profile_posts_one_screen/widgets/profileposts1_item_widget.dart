...
class Profileposts1ItemWidget extends StatelessWidget {
  Profileposts1ItemWidget(this.profileposts1ItemModelObj);

  Profileposts1ItemModel profileposts1ItemModelObj;
