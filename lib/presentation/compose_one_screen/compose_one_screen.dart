import 'bloc/compose_one_bloc.dart';
import 'models/compose_one_model.dart';
...
class ComposeOneScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<ComposeOneBloc>(
        create: (context) => ComposeOneBloc(
            ComposeOneState(composeOneModelObj: ComposeOneModel()))
          ..add(ComposeOneInitialEvent()),
        child: ComposeOneScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ComposeOneBloc, ComposeOneState>(
              ...
              appBar: CustomAppBar(
                  ...
                  title: Padding(
                      ...
                      child: Row(children: [
                        ...
                        AppbarSubtitle(
                            text: "lbl_compose".tr, margin: getMargin(left: 66))
                      ]))),
              body: Container(
                  ...
                  child: Column(
                      ...
                      children: [
                        Text("msg_compose_your_message".tr,
